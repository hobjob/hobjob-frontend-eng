...
interface CoursePageMaterialsItemProps {
    title: string;
    isLogin: boolean;
    isAdd: boolean;
    isSubscribe: boolean;
...
const CoursePageMaterialsItem: React.FC<CoursePageMaterialsItemProps> = ({
    title,
    isLogin,
    isAdd,
    isSubscribe,
        ...
        <>
            {isLogin ? (
                isAdd ? (
                    ...
                    >
                        <div className="course-page-materials-item-icon">
                            <svg
                                width="20"
                                height="20"
                                viewBox="0 0 20 20"
                    ...
                    <div
                        className="course-page-materials-item"
                        onClick={() =>
                            onClickAddCourse(`/go/passing/${courseId}/1`)
                        }
                    >
                        <div className="course-page-materials-item-icon">
                            <svg
                ...
                <div className="course-page-materials-item" onClick={openModal}>
                    <div className="course-page-materials-item-icon">
                        <svg
                            width="20"
                            height="20"
                    ...
                    <p className="course-page-materials-item__title">{title}</p>
                </div>
            )}
        </>
    );
...
export default CoursePageMaterialsItem;
